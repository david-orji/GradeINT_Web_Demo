          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button className="flex flex-col items-center justify-center p-4 border border-dashed border-slate-300 rounded-lg hover:bg-slate-50 hover:border-purple-300 hover:text-purple-600 transition-all group">
